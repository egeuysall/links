  ...
  return (
    ...
    >
      <g clipPath="url(#path0)">
        {/* Main Window Background - More accurate Apple gray tone */}
        <path
          d="M0 52H1202V741C1202 747.627 1196.63 753 1190 753H12C5.37258 753 0 747.627 0 741V52Z"
          className="fill-white dark:fill-[#1e1e1e]"
        />
        
        {/* Titlebar Background - Updated with more accurate Apple gray */}
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 12C0 5.37258 5.37258 0 12 0H1190C1196.63 0 1202 5.37258 1202 12V52H0L0 12Z"
          className="fill-[#f6f6f6] dark:fill-[#2d2d2d]"
        />
        
        {/* Inner Titlebar - With slight transparency feel */}
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        {/* Window Controls - Apple-style traffic lights */}
        <circle
          cx="27"
          cy="25"
          r="6"
          className="fill-[#FF5F57] dark:fill-[#FF5F57]"
        ...
        <circle
          ...
          cy="25"
          r="6"
          className="fill-[#FFBD2E] dark:fill-[#FFBD2E]"
          filter="drop-shadow(0px 0.5px 0.5px rgba(0, 0, 0, 0.05))"
        />
        <circle
          cx="67"
          cy="25"
          r="6"
          className="fill-[#27C93F] dark:fill-[#27C93F]"
          filter="drop-shadow(0px 0.5px 0.5px rgba(0, 0, 0, 0.05))"
        />

        {/* URL Bar - More rounded like Safari */}
        <rect
          x="286"
          y="11"
          width="666"
          height="30"
          rx="8" 
          className="fill-[#F0F0F0] dark:fill-[#404040]"
          filter="drop-shadow(0px 0.5px 0.5px rgba(0, 0, 0, 0.03))"
        />
        
        {/* Security Icon - Apple-like with gradient */}
        <g>
          <path
            ...
            className="fill-[#34C759] dark:fill-[#34C759]"
          />
        </g>
        
        {/* URL Text - San Francisco font style */}
        <g>
          <text
            x="580"
            y="30"
            className="fill-[#333333] dark:fill-[#E0E0E0]"
            fontSize="13"
        ...
        {/* Safari UI Elements - With more Apple-like colors */}
        {mode === "default" ? (
          <>
            {/* Back Button */}
            <g>
              <path
                ...
                className="fill-[#777777] dark:fill-[#A0A0A0]"
              />
            </g>
            ...
            {/* Reload Button - with Apple-style smooth curves */}
            <g>
              <path
